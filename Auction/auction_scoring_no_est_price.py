...
COVARIATES = ['estimated calories', 'actual energy density', 'liking', 'bid']
BID_DATA_PATH = "/RQ_bid_data.csv"
DATA_PATH = "/data"
OUT_DIR = "scored_no_est_price"
...
def score_subject(subjID, in_file):
    ...
    pmods_zipped = zip(bid_df['EstimatedCalories'], bid_df['ActualEnergyDensity'], bid_df['Like'], df['Bid'])
